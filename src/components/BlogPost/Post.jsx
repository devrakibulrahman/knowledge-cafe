        ...
        <div className="w-full flex flex-col items-center justify-center gap-10">
            <div className="w-full sm:w-[616px] xl:w-full 2xl:w-full">
                ...
                <div className="w-full flex items-center justify-between">
                    <div className='w-auto flex items-center justify-center gap-3'>
                        ...
                        <div className='w-auto'>
                            ...
                            <p className='font-exo2 text-xs leading-[160%] font-semibold text-[#11111199] md:text-sm 2xl:text-[16px] lg:mt-1'>Mar 14 (4 Days ago)</p>
                        </div>
                    </div>
                    <div className='w-auto flex items-center justify-center gap-2 md:gap-3'>
                        <p className='font-exo2 text-sm leading-[24px] font-medium text-[#11111199] md:text-[16px] 2xl:text-xl'>05 min read</p>
                ...
                <div className='w-full max-w-[300px] mt-4 md:max-w-[400px] xl:max-w-[500px] xl:mt-5'>
                    <h1 className='font-exo2 text-lg leading-[160%] font-bold md:text-xl xl:text-2xl xl:leading-[165%]'>How to get your first job as a self-taught programmer</h1>
                </div>
                <div className='w-full flex items-center gap-4 mt-4'>
                    <p className='font-exo2 text-sm leading-[24px] font-medium text-[#11111199] md:text-[16px] 2xl:text-xl'>#beginners</p>
                    <p className='font-exo2 text-sm leading-[24px] font-medium text-[#11111199] md:text-[16px] 2xl:text-xl'>#beginners</p>
                </div>
